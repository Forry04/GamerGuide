...
3. Ha még nincs adatbázisod, hozz létre egyet:
   - Kattints jobb egérgombbal a **Databases** mappára, majd válaszd a **New Database...** lehetőséget.
   - Adj nevet az adatbázisnak, például: `GamerGuideDB`.
